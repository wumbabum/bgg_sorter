defmodule Web.Components.LoadingSpinnerComponent do
  @moduledoc "Loading spinner component with animated SVG."

  use Phoenix.Component

  def spinner(assigns) do
    ~H"""
    <svg class="loading-svg" fill="#3f3f74" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
