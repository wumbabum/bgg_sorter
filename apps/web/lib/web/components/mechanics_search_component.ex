defmodule Web.Components.MechanicsSearchComponent do
  ...
  attr :mechanics_loading, :boolean, default: false, doc: "Whether mechanics are currently loading"
                ...
                <% else %>
                  ...
                  <%= cond do %>
                    ...
                    <% Enum.empty?(@popular_mechanics) -> %>
                      <p class="mechanics-loading">No mechanics available yet. Mechanics are populated when games are loaded from BoardGameGeek.</p>
                    <% true -> %>
